...
resource "oci_core_instance" "vm2" {
    ...
    provisioner "file" {
      source = "./python-rest-api.sh"
      destination = "/home/opc/python-rest-api.sh"
    }

    provisioner "remote-exec" {
      inline = [
        "echo ${self.public_ip} > /home/opc/public_ip",
        "chmod 777 /home/opc/python-rest-api.sh",
        "sudo /home/opc/python-rest-api.sh"
      ]
    }
